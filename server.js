...
function initDatabase() {
  db.serialize(() => {
    ...
    // Poblar desde metro_stations.json usando require (compatible con Vercel)
    const metroStations = require('./metro_stations.json');
    console.log('✅ Estaciones del Metro CDMX cargadas correctamente desde metro_stations.json');
